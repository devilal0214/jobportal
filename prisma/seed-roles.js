...
async function main() {
  ...
  const permissions = [
    ...
    },
    {
      ...
      action: "assign",
      name: "Assign Jobs",
      description: "Assign jobs to other users",
    },
    {
      module: "jobs",
      action: "pause",
      name: "Pause Jobs",
      description: "Pause/unpause job postings",
    },
    ...
    },
    {
      ...
      description: "Update application status and add remarks",
    },
    {
      module: "applications",
      action: "archive",
      name: "Archive Applications",
      description: "Archive and unarchive applications",
    },
    {
      module: "applications",
      action: "export",
    ...
    },
    {
      ...
      description: "Permanently delete applications",
    },
    ...
    // Email permissions
    {
      ...
      description: "View email templates and logs",
    },
    {
      module: "email",
      action: "update",
      name: "Manage Email Templates",
      description: "Edit email templates and settings",
    },

    // Careers settings permissions
    {
      module: "careers-settings",
      action: "read",
      name: "View Careers Settings",
      description: "View careers page settings and options",
    },
    {
      module: "careers-settings",
      action: "update",
      name: "Manage Careers Settings",
      description: "Update careers page settings and configuration",
    },
    ...
    },
    {
      ...
      action: "read",
      name: "View Forms",
      description: "View application forms",
    },
    {
      module: "forms",
      action: "update",
      name: "Edit Forms",
      description: "Edit application forms",
    },
    {
      module: "forms",
      action: "delete",
  ...
  for (const permission of permissions) {
    await prisma.permission.upsert({
      where: {
        module_action: { module: permission.module, action: permission.action },
      },
      update: {},
      create: permission,
    });
  ...
  const hrPermissions = allPermissions.filter(
    (p) =>
      ["dashboard", "jobs", "applications", "forms", "email"].includes(
        p.module,
      ) ||
  ...
  const managerPermissions = allPermissions.filter(
    (p) =>
      ...
      (p.module === "jobs" &&
        ["create", "read", "update", "assign"].includes(p.action)) ||
      (p.module === "applications" &&
        ["read", "update", "archive"].includes(p.action)) ||
      (p.module === "forms" &&
  ...
  for (const user of existingUsers) {
    ...
    const roleToAssign =
      existingUsers.indexOf(user) === 0 ? adminRole.id : hrRole.id;
  ...
  if (userCount === 0) {
    ...
    console.log(
      "✅ Created demo admin user (admin@jobportal.com / admin123)\n",
    );
  }
  ...
  console.log(
    "- Manager: View dashboard, manage assigned jobs, applications, and forms (create, read, update)",
  );
