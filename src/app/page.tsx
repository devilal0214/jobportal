        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-200 p-6 cursor-pointer group-hover:scale-105">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-600 truncate">Pending Applications</p>
                  <p className="text-2xl font-semibold text-gray-900">{stats.pendingApplications}</p>
                </div>
              </div>
              <div className="mt-2">
                <p className="text-xs text-blue-600 group-hover:text-blue-700">View pending →</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/applications" className="group">
            <div className="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-200 p-6 cursor-pointer group-hover:scale-105">
              ...
              <div className="mt-2">
                <p className="text-xs text-green-600 group-hover:text-green-700">View all →</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/applications?status=UNDER_REVIEW" className="group">
            <div className="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-200 p-6 cursor-pointer group-hover:scale-105">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-600 truncate">Under Review</p>
                  <p className="text-2xl font-semibold text-gray-900">{stats.underReview}</p>
                </div>
              </div>
              <div className="mt-2">
                <p className="text-xs text-yellow-600 group-hover:text-yellow-700">Review queue →</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/jobs" className="group">
            <div className="bg-white rounded-lg shadow hover:shadow-lg transition-all duration-200 p-6 cursor-pointer group-hover:scale-105">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-600 truncate">Total Jobs</p>
                  <p className="text-2xl font-semibold text-gray-900">{stats.totalJobs}</p>
                </div>
              </div>
              <div className="mt-2">
                <p className="text-xs text-purple-600 group-hover:text-purple-700">Manage jobs →</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="divide-y divide-gray-200">
              {recentApplications.map((application) => (
                <div key={application.id} className={getApplicationRowStyle(application.status)}>
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-1 flex items-center justify-between">
                        ...
                        >
                          {isUnreadApplication(application.status) ? 'Review' : 'View'}
                        </Link>
                      </div>
                    </div>
                  </div>
