...
export function getRolePermissions(role: string) {
  // Normalize role strings (accept 'ADMIN', 'Administrator', 'Manager', etc.)
  ...
  // Default to most-restrictive (viewer) when role not recognized
  return permissionsMap[key] || permissionsMap.viewer;
}
